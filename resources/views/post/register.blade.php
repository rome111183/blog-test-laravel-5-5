    ...
    <div class="row">
        <div class="col-md-offset-0">
            <div class="panel panel-default">
                <div class="panel-heading">Register new Post</div>
                <div class="panel-body">
                    {!! Form::model('', [
                        ...
                        <div class="form-group{{ $errors->has('contents') ? ' has-error' : '' }}">
                            <label for="contents" class="col-md-12 control-label">Contents</label>
                            <div class="col-md-12 col-md-offset-0">
                              <table class="col-md-12 col-md-offset-0">
                              <tr>
                                <td style="width: 50%;">
                                  <div class="">
                                      <textarea class="form-control" rows="25" id="contents" name="contents">{{ old('contents') }}</textarea>
